...
export const recommendations: Recommendation[] = [
  ...
  },
  {
    ...
    textFr: "J'ai eu le plaisir de travailler avec Moussandou pendant plusieurs mois. Ce qui le caractérise principalement, c'est avant tout sa vivacité d'esprit remarquable, qui lui permet de s'adapter à toutes les situations avec un souci constant d'amélioration. Il a également une capacité naturelle à traduire ses idées en actions concrètes pour les rendre réalisables. Pour cela, il s'appuie sur ses compétences naturelles, mais sait aussi s'appuyer sur l'intelligence collective et le travail d'équipe. Moussandou ira loin, j'en suis certain. Si vous lui offrez un environnement bienveillant lui permettant d'exploiter pleinement ses nombreux talents, il sera le genre de collaborateur apportant un leadership innovant et humain à votre entreprise.",
  ...
  },
  {
    ...
    textFr: "J'ai eu la chance de travailler avec Moussandou Mroivili pendant trois ans à Epitech. Il prenait très souvent le lead lors des projets de groupe et donnait toujours le meilleur de lui-même pour faire avancer l'équipe. Il s'impliquait énormément, contribuait à créer une bonne cohésion et restait toujours motivé à innover et résoudre des problèmes complexes en informatique. Travailler avec lui a été une formidable expérience.",
  ...
  },
  {
    ...
    textFr: "Au cours de ses années à Epitech, Moussandou a toujours été un étudiant ambitieux et impliqué, menant des projets et étant reconnu par ses pairs comme un véritable leader et un développeur de premier plan. Il a toujours été désireux de s'investir dans des événements internes et externes. Il a fait preuve d'une éthique de travail incroyable et d'une capacité constante à progresser et à tirer les autres vers le haut. Je travaillerais très volontiers avec lui si l'occasion se présente.",
  ...
  },
  {
    ...
    textFr: "J'ai travaillé avec Moussandou sur le certificat IA et Entrepreneuriat à HEC Paris. En tant que diplômé d'école de commerce avec quelques années d'expérience, j'ai été immensément impressionné par son sens des affaires et son goût pour l'action lorsqu'il a fallu développer notre produit. Il a largement dépassé mes attentes et sait réfléchir simultanément en termes business et techniques. Il était très proactif et apportait d'excellentes idées sur le choix des fonctionnalités et la résolution des problèmes utilisateurs. Ce serait un plaisir de travailler à nouveau avec Moussandou et quiconque aura la chance de collaborer avec lui le constatera par lui-même.",
  ...
  },
  {
    ...
    textFr: "Ces trois dernières années à Epitech, Moussandou a toujours été reconnu par ses camarades comme un leader naturel et a souvent été choisi pour diriger les projets de groupe. Il ne fuit jamais le travail et s'efforce toujours de mener les projets à terme, souvent au-delà des attentes. Il s'est constamment dépassé en participant à des événements et défis externes pour enrichir ses connaissances et atteindre l'excellence. Ce qui ressort encore plus, c'est son attitude positive : il est toujours focalisé sur la recherche de solutions au sein de l'équipe. Au-delà de ses compétences de leader, Moussandou a démontré de solides capacités techniques et une réelle faculté d'apprentissage rapide. Je travaillerais volontiers avec lui dès que l'occasion se présentera.",
  ...
  },
  {
    ...
    textFr: "Moussandou a rejoint l'équipe du GDG Marseille à nos débuts, et ce fut un vrai plaisir de travailler avec lui. Arrivé avec beaucoup d'enthousiasme, il s'est immédiatement investi pour faire avancer nos projets techniques. Au-delà de son engagement et de ses compétences de développeur, c'est avant tout un moteur pour l'équipe : fiable, proactif et très curieux. C'est le genre de personne sur qui l'on peut compter pour faire aboutir les projets. Je suis ravie de l'avoir avec nous et je le recommande sans hésitation !",
  ...
  },
  {
    ...
    textFr: "Je recommande vivement Moussandou Mroivili pour son dévouement et son professionnalisme durant le projet d'études Bingeki. Tout au long du projet, il a fait preuve d'une forte motivation, d'une grande fiabilité et d'une capacité à s'adapter rapidement aux nouveaux défis dans un environnement académique collaboratif. Moussandou a constamment montré d'excellentes compétences en travail d'équipe et en communication tout en accomplissant ses tâches avec sérieux et autonomie. Son attitude positive et son engagement ont grandement contribué au succès du projet.",
  ...
  },
  {
    ...
    textFr: "J'ai eu le plaisir d'encadrer Moussandou lors de son stage à l'ICOM'Provence fin 2024. Il a joué un rôle clé dans le développement de notre MOOC sur l'autonomie numérique pour les personnes en situation de handicap (autonomie-numerique.fr). Moussandou maîtrise parfaitement le développement web et la gestion de CMS (WordPress). Au-delà de ses compétences techniques, c'est un professionnel fiable avec un excellent esprit d'équipe et une forte capacité d'adaptation. Je le recommande vivement pour toute opportunité future, en France ou à l'étranger.",
  ...
  },
  {
    ...
    textFr: "J'ai eu le plaisir de travailler avec Moussandou lors du premier hackathon d'agents IA, HACKTOGONE, où nous avons collaboré au sein de la même équipe. Dès le début, il s'est distingué par son investissement, sa fiabilité, ainsi que sa gentillesse et son esprit d'équipe. Moussandou est un développeur très compétent, toujours prêt à aider et partager ses idées pour faire avancer le projet. Son engagement et son professionnalisme ont fait une vraie différence durant l'événement. C'était un vrai plaisir de travailler avec lui !",
